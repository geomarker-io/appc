...
**update descriptions for cass-crossover throughout**
...
```{r}
dates_seq <- seq(min(d$case_date), max(d$case_date), by = 1)
...
d <- d |> dplyr::mutate(pm25 = predict_pm25(s2, dates, quiet = FALSE))
